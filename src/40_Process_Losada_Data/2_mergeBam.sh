...
# Input
inputFileName="/projects/ag-papan/eduardo/Wendt_Stag/Code/9_Process_Losada_Data/input/2_meb.txt"
parameters=`sed "${SLURM_ARRAY_TASK_ID}q;d" $inputFileName`

# Creating matrix
python /projects/ag-papan/eduardo/Wendt_Stag/Code/9_Process_Losada_Data/2_mergeBam.py $parameters
