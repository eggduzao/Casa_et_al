...
# squeue -u egusmao
# scancel 10869146, 10870416, 10929861
...
# Input
inputFileName="/projects/ag-papan/eduardo/Wendt_Stag/Code/9_Process_Losada_Data/input/1_alg.txt"
parameters=`sed "${SLURM_ARRAY_TASK_ID}q;d" $inputFileName`

# Creating matrix
python /projects/ag-papan/eduardo/Wendt_Stag/Code/9_Process_Losada_Data/1_alignment.py $parameters
