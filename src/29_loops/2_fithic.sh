...
#SBATCH --output=FITHIC.out
#SBATCH --error=FITHIC.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=24gb
#SBATCH --time=1:00:00
...
# Input
inputFileName="/projects/ag-papan/eduardo/Papantonis_Stag/Code/29_loops/input/"${SLURM_ARRAY_TASK_ID}".txt"
...
# Execution
python /projects/ag-papan/eduardo/Papantonis_Stag/Code/29_loops/2_fithic.py $resolution $lowerBound $upperBound $equalOcBinNb $splineTimes $contactFileName $fragmentFileName $outputName $outputLocation
