...
enhancerFileName = sys.argv[6]
h3k4me1FileName = sys.argv[7]
h3k4me3FileName = sys.argv[8]
h3k27acFileName = sys.argv[9]
ctcfFileName = sys.argv[10]
tempLocation = sys.argv[11]
outputBedFileName = sys.argv[12]
outputBamFileName = sys.argv[13]
...
for line in aliasFile:
  ...
  for g in geneList: aliasDict[g.upper()] = value
aliasFile.close()
...
for chrom in chromList:
  ...
  for i in range(0, chromSizesDict[chrom], step):
    ...
    for read in h3k4me1Fetch:
      ...
      gSum = sum(1 for _ in ensemblFetch)
