...
# Test
#fc = F
#regionName = gsub("_", " ", "REGION_NAME_aaaa_aaaaa_aaaa")
#signalName = gsub("_", " ", "SIGNAL_NAME")
#inputMatrixFileName = "/home/egg/Projects/Wendt_Stag/Results/11_Insulation_Plot/1_Insulation_Table/10K_norm/STAG1_only/STAG1_DEG.txt"
#outputFileName = "./STAG1_DEG.pdf"
...
insulationPlot <- function(fc, regionName, signalName, matrix, outputFileName){
  ...
  # Writing Image
  #myImage = image_read(outputFileName)
  #myImage = image_chop(myImage, "100%x30%")
  #image_write(myImage, path = outputFileName)
