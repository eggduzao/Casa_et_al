...
suby = as.numeric(args[2])
chromosome = args[3]
contrName = args[4]
treatName = args[5]
inputTableFileName1 = args[6]
inputTableFileName2 = args[7]
...
vecY = c(log10(as.numeric(scoreVector1Binned)) - suby, log10(as.numeric(scoreVector2Binned)))
vecGroup = c(rep(contrName,length(scoreVector1Binned)), rep(treatName,length(scoreVector2Binned)))
