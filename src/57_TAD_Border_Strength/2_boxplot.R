...
# Input
inputFileName = "/usr/users/egadegu/Projects/Wendt_Stag/Results/28_TAD_Border_Strength/table.txt"
outputFileName = "/usr/users/egadegu/Projects/Wendt_Stag/Results/28_TAD_Border_Strength/tad_border_strength.pdf"
