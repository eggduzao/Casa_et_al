...
# Input
il = "/usr/users/egadegu/Projects/Wendt_Stag/Results/42_FigS9H_AvgDiffInt_RaoNeg/1_Tables/"
ol = "/usr/users/egadegu/Projects/Wendt_Stag/Results/42_FigS9H_AvgDiffInt_RaoNeg/2_Plots/"
stagList = c("STAG1+_inter", "STAG1+_intra", "STAG2+_inter", "STAG2+_intra")
ylim1List = c(-160, -300, -10, -120)
ylim2List = c(110, 70, 40, 50)
