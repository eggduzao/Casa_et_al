...
# Slurm Parameters
#SBATCH --job-name=MGS
#SBATCH --output=MGS.%A_%a.out
#SBATCH --error=MGS.%A_%a.err
#SBATCH --nodes=1
#SBATCH --mem=24gb
#SBATCH --time=5:00:00
...
# Input
inputFileName="/projects/ag-papan/eduardo/Wendt_Stag/Code/8_Meta_Plots_Genes/input/1_mgs.txt"
parameters=`sed "${SLURM_ARRAY_TASK_ID}q;d" $inputFileName`

# Creating matrix
python /projects/ag-papan/eduardo/Wendt_Stag/Code/8_Meta_Plots_Genes/1_metaGene_StagSignal.py $parameters
