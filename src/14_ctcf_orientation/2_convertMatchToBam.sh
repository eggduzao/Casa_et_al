...
# Input
inputFileName="/projects/ag-papan/eduardo/Papantonis_Stag/Code/14_ctcf_orientation/input_b2b/"${SLURM_ARRAY_TASK_ID}".txt"
bedFileName=`sed '1q;d' $inputFileName`
chromSizesFileName=`sed '2q;d' $inputFileName`
tempLoc=`sed '3q;d' $inputFileName`
outputFileName=`sed '4q;d' $inputFileName`

# Execution
python /projects/ag-papan/eduardo/Papantonis_Stag/Code/14_ctcf_orientation/3_convertMatchToBam.py $bedFileName $chromSizesFileName $tempLoc $outputFileName
